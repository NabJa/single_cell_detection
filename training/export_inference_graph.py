...
print("Setting sys paths")
sys.path.insert(0, "C:\\Users\\N.Jabareen\\Projects\\TensorFlow\\models")
sys.path.insert(
    0, "C:\\Users\\N.Jabareen\\Projects\\TensorFlow\\models\\research")
sys.path.insert(
    0, "C:\\Users\\N.Jabareen\\Projects\\TensorFlow\\models\\research\\object_detection")
sys.path.insert(
    0, "C:\\Users\\N.Jabareen\\Projects\\TensorFlow\\models\\research\\slim")
sys.path.insert(
    0, "C:\\Users\\N.Jabareen\\Projects\\TensorFlow\\models\\research\\slim\\nets")
...
def determine_latest_model(path):
    ckpts = [re.findall(r"\d+", i)[0]
             for i in os.listdir(path) if "model.ckpt" in i]
    for ckpt in ckpts[::-1]:
        if ckpts.count(ckpt) == 3:
            print("Saving model ckpt:", ckpt)
            return f"model.ckpt-{ckpt}"
    print("Warning no checkpoint found in ", path)
